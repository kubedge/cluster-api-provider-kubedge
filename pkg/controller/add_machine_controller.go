...
//+kubebuilder:rbac:groups=kubedge.k8s.io,resources=kubedgemachineproviderspecs;kubedgemachineproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
