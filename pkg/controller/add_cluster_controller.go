...
//+kubebuilder:rbac:groups=kubedge.k8s.io,resources=kubedgeclusterproviderspecs;kubedgeclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
